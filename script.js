...
pizzaJson.map((item, index) => {
  ...
  pizzaItem.querySelector("a").addEventListener("click", (e) => {
    ...
    c(".pizzaWindowArea").style.display = "flex"; //modal
...
//Adiciona e reduz a quantidade de pizzas:
//Add
...
// Add evento de click na seleção de tamanho:
cs(".pizzaInfo--size").forEach((size, sizeIndex) => {
...
c(".pizzaInfo--addButton").addEventListener("click", () => {
  ...
  //Mostra se já apresenta o item no carrinho.
